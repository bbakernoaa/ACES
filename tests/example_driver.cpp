 ...
 */
void Atmosphere_ProvideData(ESMC_Field f_temp, ESMC_Field f_wind, int step,
...
int main(int argc, char** argv) {
  ...
  for (int step = 0; step < 5; ++step) {
    ...
    ESMC_FieldWrite(f_total, filename, "total_nox", 1, ESMC_FILESTATUS_REPLACE,
                    step + 1, ESMF_IOFMT_NETCDF);
